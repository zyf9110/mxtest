Page({
  ...
  Locktouzi0:function(event){
    var sno=Number(event.currentTarget.dataset.sno);
    this.Locktouzi(sno);
  },
   Locktouzi:function (sno){
...
gameagain:function(){
 ...
 AI_go:function(){
   var lock1=this.data.lock1;
  var sno = 0;
  var touzi1=this.data.dicearray1;
  var turn1=this.data.turn1;
  //
  if(lock1.length == 5){
      turn1 = true;
  ...
  //笨比ai逻辑
  else if(lock1.length < 5){
      this.Touzishow(touzi1, lock1);

      for(var i = lock1.length, j = 0; i < 5; i ++){
          lock1[i] = touzi1[j];
          j ++;
      }
      turn1 = true;
  ...
  */
      ...
      if(lock1.length == 0){
          ...
          if(counts == 5){
          ...
          else if(counts[0] == 1 && touzi1[4] - touzi1[0] == 4){
              for(var i = 0; i < 5; i ++){
                  lock1[i] = touzi1[i];
                  locksno1[i] = i;
              }
              ...
              else if(touzi1[0] != touzi1[1]){
                  if(touzi1[0] == touzi1[2]){
              ...
              for(var i = 0; i < 4; i = i){
                  if(j == 2){
                      ...
                      if(touzi1[i] == touzi1[i + 1]){
                          j ++;
                          i ++;
                      }
                      else if(touzi1[i] != touzi1[i + 1]){
                          i ++;
                          j = 0;
                      }
                  }
          ...
          else if(counts[0] == 2 && touzi1[4] - touzi1[0] == 3){
              var j = 0;

              for(var i = 0; i < 4; i = i){
                  if(touzi1[i + 1] - touzi1[i] == 1){
                      lock1[j] = touzi1[i];
                      locksno1[j] = i;
                      i ++;
                      j ++;
                  }
                  else if(touzi1[i + 1] - touzi1[i] != 1){
                      i ++;
                  }
              }
          }
          else if(lock1.length < 100){
              turn1 = true;
              this.setData({
                lock1:lock1,
                locksno1:locksno1,
      ...
      else if(lock1.length > 0 && lock1.length < 5){
          this.dicechange1();
          var lkl1 = lock1.length;
          for(var i = lkl1; i < 5; i ++){
              lock1[i] = touzi1[i - lkl1];
